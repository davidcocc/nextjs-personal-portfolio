...
const projectsData = [
  {
    id: 1,
    title: "Space Buddy",
    description: "[WIP] - This project is being developed for the Enterprise Mobile Application Development exam at the University of Salerno (Master's Degree). It is an application in VR aimed at providing companionship to young users through a small robotic friend, known as Buddy, an animated chatbot powered by Google Bard. In addition to chatbot functionalities, Buddy will engage users with games, animations, and even be customizable! The project is being developed in Unity by me and my team, and the target platform is the Meta Quest 2. Personally, I am responsible for the development of the chatbot, 3D modeling and rigging, as well as playing a leadership role within the working group.",
  ...
  },
  {
    ...
    description: "[WIP] - This project is being developed for the Data Analysis and Statistics exam at the University of Salerno. (Master's Degree). The goal of this project is to become familiar not only with R language, but with concepts of mathematical statistics in general at a particularly high level. It is really being fun and interesting to learn new stuff by exploring functions and formulas; we are using a dataset of technologic development indicators in several nations, evaluating how this correlates with the gross domestic product (GDP) of various countries and the allocation of funds invested in this direction.",
