...
const ResponsiveSlider = () => {
  ...
  return (
    ...
    <p className="text-[#f1f1f1] sm:text-lg mt-2 mb-8 lg:text-xl lg:text-center xl:text-center sm:text-center md:text-center">
      Over the past three years, I have curated a collection of my favorite tracks. If you are curious to learn more about me, I invite you to take a listen to <strong>this month playlist!</strong>
    </p>
